(function ($) {
    ...
    var MagicSuggest = function (element, options) {
        ...
        var defaults = {
            ...
            mode: "local",
            name: null,
            noSuggestionText: "Sem sugest�es.",
            ...
            _displaySuggestions: function (data) {
                ...
                if (data !== null) {
                    ...
                    if (typeof data === "string") {
                        ...
                        $.ajax({
                            type: cfg.method, url: data, data: params, success: function (asyncData) {
        ...
        var handlers = {
            _onBlur: function () {
                ...
                var active = ms.combobox.find(".ms-res-item-active:first"), freeInput = ms.input.val();
