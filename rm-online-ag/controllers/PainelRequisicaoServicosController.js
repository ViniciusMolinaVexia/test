function painelRequisicaoServicosServ($scope, loading, rmAprovacaoService, RmaServicoService, AutoComplete, Combo, $http, PainelRequisicaoServicosService) {
    ...
    $scope.reprovar = function() {
        ...
        if (!$scope.rmMaterial.justificativaReprovacao) {
            ...
            PainelRequisicaoServicosService.reprovar(request, $scope.retornoReprovar, $scope.retornoErro);
        }
    };
    ...
    $scope.listar = function() {
        ...
        if ($scope.centroSelecionado) {
            $scope.filtro.centro = $scope.centroSelecionado.codigo;
        }


        PainelRequisicaoServicosService.listar($scope.filtro, retornoListar, $scope.retornoErro);
    }
    ...
    $scope.irParaPaginaEspecifica = function(pagina) {
        ...
        if (pagina !== paginaAtual) {
            ...
            PainelRequisicaoServicosService.listar($scope.filtro, $scope.retornoListar, $scope.retornoErro);
        }
    };
    ...
    function processarRequisicaoReserva() {
        ...
        PainelRequisicaoServicosService.enviarReservaSAP(requisicoes, $scope.enviadoSAP, $scope.enviadoSAPErro);
    }
    ...
    function processarRequisicaoCompra() {
        ...
        angular.forEach($scope.enviarSap, function(req) {
            ...
            request.usuarioCadastro = req.cadastrante;
            request.grupoCompradores = req.grupoCompradores;
        ...
        PainelRequisicaoServicosService.enviarSAP(requisicoes, $scope.enviadoSAP, $scope.enviadoSAPErro);
    }
