        ...
        return {
            link: function (b, c, d) {
                a.isHTML5 || c.removeAttr("multiple"), c.bind("change", function () {
                    b.$emit("file:add", a.isHTML5 ? this.files : this, b.$eval(d.ngFileSelect)), a.isHTML5 && c.prop("value", null)
                }), c.prop("value", null)
            }
        }
        ...
        function g(c) {
            if (!f.prototype.isHTML5) {
                ...
                c.file = {
                    ...
                    type: "like/" + g.replace(/^.+\.(?!\.)|.*/, ""),
                    name: g.match(/[^\\]+$/)[0]
                }, c._input = d, e.prop("value", null), d.hide().after(e)
            }
            a.extend(this, {
                isReady: !1,
                isUploading: !1,
            ...
            _filter: function (b) {
                ...
                a.forEach(e, function (b) {
                    ...
                    if (d) {
                        ...
                        this.queue.push(e), this.trigger("afteraddingfile", e)
                    }
                }, this), this.queue.length !== d && (this.trigger("after:adding:all", this.queue), this.progress = this._getTotalProgress()), this._render(), this.autoUpload && this.uploadAll()
                ...
                b._form && b._form.replaceWith(e), b._form = c, this.trigger("beforeupload", b), e.prop("name", b.alias), b.formData.forEach(function (b) {
                    ...
                    var a = {
                        response: d.contents()[0].body.innerHTML,
                        status: 200,
                        dummy: !0
                    }, c = f._transformResponse(a.response);
                    f.trigger("in:success", a, b, c), f.trigger("in:complete", a, b, c)
                }), c.abort = function () {
