            ...
            w = function () {
                ...
                if ("check" == b) {
                    if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
                        var f = a.getValueOf("info", "txtWidth"), c = a.getValueOf("info", "txtHeight"), d = 1E3 * d.$.width / d.$.height, e = 1E3 * f / c;
                        a.lockRatio = !1;
                ...
                id: "advanced", label: c.lang.common.advancedTab, elements: [{
                    ...
                    setup: function (a,
                        ...
                        if (a == e) {
                            ...
                            this.setValue(c);
                            var f = b.$.style.height, c = b.$.style.width, f = (f ? f : "").match(k), c = (c ? c : "").match(k);
